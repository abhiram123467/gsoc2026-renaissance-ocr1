...
## 📌 Project Overview
This repository contains the architecture prototype and evaluation pipeline for the **GSoC 2026 HumanAI — RenAIssance OCR-1** project. The core objective is to build and scale a Convolutional Recurrent Neural Network (CRNN) to accurately transcribe 17th-century Spanish historical texts, overcoming the challenges of rare letterforms, complex diacritics, and variable typographies.
